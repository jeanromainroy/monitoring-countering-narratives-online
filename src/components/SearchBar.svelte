<script>
    ...
    // locale lib
    import { clean_str } from '../libs/strings.js';
...
<div id="search-bar" style="margin: auto;">
    <input type="text" placeholder={placeholder} bind:value={_value}>
...
<style>
    ...
    #search-bar > input:focus {
        outline: 0;
        -webkit-box-shadow: inset 0 2px 2px rgba(0, 0, 0, 0.075), 0 0 8px var(--black-light);
        box-shadow: inset 0 2px 2px rgba(0, 0, 0, 0.075), 0 0 8px var(--black-light);
    }
